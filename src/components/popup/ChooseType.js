...
const buttonVoluntario = { backgroundColor: '#00bcd4', marginBottom: 10 , marginTop: 10 , lineHeight: "40px" } 
...
return (
    <div>
        ...
        <Button variant="contained" onClick={changePopupVoluntario} size="large" style={buttonVoluntario} fullWidth>Voluntário</Button>
        <Button variant="contained" onClick={changePopupOrganizacao} size="large" style={buttonOrganizacao} fullWidth>Organização</Button>
    </div>
)
}
